...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.i2i.vehicleloan.service.impl.PasswordTokenManager#generateRecoveryToken(com.i2i.vehicleloan.model.User)
     */
    @Override
    ...
    /**
     * @see com.i2i.vehicleloan.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.i2i.vehicleloan.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.i2i.vehicleloan.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
