            ...
            <thead>
                ...
                <c:forEach items = "${usersDetail}" var = "userDetail">
                    <tr class ="info">
                        ...
                        <td><c:out value="${userDetail.phoneNumber}" /></td>
                        <td><c:out value="${userDetail.email}" /></td>
                        <td><a href = "retrieveUserAddress?userId=${userDetail.id}"> view address</a></td>
                        <td><a href = "retrieveUserEligibilityDetail?userId=${userDetail.id}"> view eligibility detail</a></td>
                        <td><a href = "retrieveLoanDetail?userId=${userDetail.id}"> view loan detail</a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
